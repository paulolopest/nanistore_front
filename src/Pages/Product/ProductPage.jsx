...
const ProductPage = () => {
    ...
    return (
        <div className="flex h-screen w-screen justify-between bg-neutral-100 px-36 py-10">
            <div className="flex h-[46rem] w-[60rem] items-center justify-between rounded-xl bg-white px-8 py-5 shadow-md">
            ...
            <div className="flex h-[46rem] w-[36rem] flex-col justify-between rounded-xl bg-white p-7 shadow-md">
                <div className="flex flex-col gap-5">
                    <span className="text-sm font-semibold uppercase text-neutral-400">
                        Novo | 120389 vendidos
                    </span>

                    <span className="relative text-3xl font-extrabold uppercase">
                    ...
                    <div className="flex flex-col justify-start gap-2 text-2xl font-semibold uppercase">
                        ...
                        <p className="flex items-center gap-3 text-5xl font-extrabold">
                            ...
                            <span className="rounded-md bg-green-500 px-2 py-1 text-lg text-white">-10%</span>
                        </p>
