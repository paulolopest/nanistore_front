...
const ProfileModal = () => {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute -right-2 top-9 z-50 flex h-64 w-60 flex-col justify-between rounded-xl bg-white pt-2 font-light text-neutral-600 shadow-hover max-1024:right-0 "
        >
            <div>
