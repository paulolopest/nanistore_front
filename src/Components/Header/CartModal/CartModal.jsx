...
const CartModal = () => {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute -right-2 top-9 z-10 flex w-72 flex-col justify-between rounded-xl bg-white shadow-hover max-1024:-right-16 max-540:-right-12"
        >
            ...
            <div className="flex flex-col gap-2 border-1 border-x-0 border-b-0 border-solid border-t-neutral-100 px-4 py-2">
                <div className="flex items-center justify-between text-neutral-400">
                    <p>Total:</p>
                    <p className="font-bold text-neutral-600">R$ 149,99</p>
                </div>

                <div className="flex h-10 items-center justify-end text-sm">
                    <Link
                        to={'/cart'}
                        className="rounded-md bg-neutral-800 px-2 py-1 text-neutral-200 hover:bg-neutral-700"
