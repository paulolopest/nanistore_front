...
const CartModal = () => {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute -right-2 top-9 z-10 flex w-72 flex-col justify-between rounded-xl bg-white font-light shadow-hover max-1024:-right-16 max-540:-right-12"
        >
