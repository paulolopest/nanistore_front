...
const ProductCard = ({ item, className }) => {
    ...
    return (
        <motion.div
            ...
            className={`flex h-[32rem] w-[313px] shrink-0 cursor-pointer select-none flex-col justify-center gap-2 overflow-hidden rounded-2xl bg-white p-2 shadow-md transition-shadow duration-150 ease-linear hover:shadow-hover ${className}`}
        >
